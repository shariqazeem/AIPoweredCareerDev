...
class ProfileQuizStep4Form(forms.ModelForm):
    ...
    all_fields = {
        ...
        'management': forms.ChoiceField(choices=skill_levels, widget=forms.Select(attrs={'class': 'form-control'}), label='Management Skill Level', required=False),
        'marketing': forms.ChoiceField(choices=skill_levels, widget=forms.Select(attrs={'class': 'form-control'}), label='Marketing Skill Level', required=False),
        'finance': forms.ChoiceField(choices=skill_levels, widget=forms.Select(attrs={'class': 'form-control'}), label='Finance Skill Level', required=False),
        'sales': forms.ChoiceField(choices=skill_levels, widget=forms.Select(attrs={'class': 'form-control'}), label='Sales Skill Level', required=False),
        'drawing': forms.ChoiceField(choices=skill_levels, widget=forms.Select(attrs={'class': 'form-control'}), label='Drawing Skill Level', required=False),
        'painting': forms.ChoiceField(choices=skill_levels, widget=forms.Select(attrs={'class': 'form-control'}), label='Painting Skill Level', required=False),
        'sculpting': forms.ChoiceField(choices=skill_levels, widget=forms.Select(attrs={'class': 'form-control'}), label='Sculpting Skill Level', required=False),
        'photography': forms.ChoiceField(choices=skill_levels, widget=forms.Select(attrs={'class': 'form-control'}), label='Photography Skill Level', required=False),
        'instrument_playing': forms.ChoiceField(choices=skill_levels, widget=forms.Select(attrs={'class': 'form-control'}), label='Instrument Playing Skill Level', required=False),
        'vocals': forms.ChoiceField(choices=skill_levels, widget=forms.Select(attrs={'class': 'form-control'}), label='Vocals Skill Level', required=False),
        'composition': forms.ChoiceField(choices=skill_levels, widget=forms.Select(attrs={'class': 'form-control'}), label='Composition Skill Level', required=False),
        'music_production': forms.ChoiceField(choices=skill_levels, widget=forms.Select(attrs={'class': 'form-control'}), label='Music Production Skill Level', required=False),
        'music_theory': forms.ChoiceField(choices=skill_levels, widget=forms.Select(attrs={'class': 'form-control'}), label='Music Theory Skill Level', required=False),
        'conducting': forms.ChoiceField(choices=skill_levels, widget=forms.Select(attrs={'class': 'form-control'}), label='Conducting Skill Level', required=False),
        'team_sports': forms.ChoiceField(choices=skill_levels, widget=forms.Select(attrs={'class': 'form-control'}), label='Team Sports Skill Level', required=False),
        'individual_sports': forms.ChoiceField(choices=skill_levels, widget=forms.Select(attrs={'class': 'form-control'}), label='Individual Sports Skill Level', required=False),
        'coaching': forms.ChoiceField(choices=skill_levels, widget=forms.Select(attrs={'class': 'form-control'}), label='Coaching Skill Level', required=False),
        'fitness': forms.ChoiceField(choices=skill_levels, widget=forms.Select(attrs={'class': 'form-control'}), label='Fitness Skill Level', required=False),
        'nutrition': forms.ChoiceField(choices=skill_levels, widget=forms.Select(attrs={'class': 'form-control'}), label='Nutrition Skill Level', required=False),
        'physiotherapy': forms.ChoiceField(choices=skill_levels, widget=forms.Select(attrs={'class': 'form-control'}), label='Physiotherapy Skill Level', required=False),
        'sports_management': forms.ChoiceField(choices=skill_levels, widget=forms.Select(attrs={'class': 'form-control'}), label='Sports Management Skill Level', required=False),
        'fashion_designing': forms.ChoiceField(choices=skill_levels, widget=forms.Select(attrs={'class': 'form-control'}), label='Fashion Designing Skill Level', required=False),
        'fashion_styling': forms.ChoiceField(choices=skill_levels, widget=forms.Select(attrs={'class': 'form-control'}), label='Fashion Styling Skill Level', required=False),
        'fashion_illustration': forms.ChoiceField(choices=skill_levels, widget=forms.Select(attrs={'class': 'form-control'}), label='Fashion Illustration Skill Level', required=False),
        'fashion_merchandising': forms.ChoiceField(choices=skill_levels, widget=forms.Select(attrs={'class': 'form-control'}), label='Fashion Merchandising Skill Level', required=False),
        'textile_design': forms.ChoiceField(choices=skill_levels, widget=forms.Select(attrs={'class': 'form-control'}), label='Textile Design Skill Level', required=False),
        'pattern_making': forms.ChoiceField(choices=skill_levels, widget=forms.Select(attrs={'class': 'form-control'}), label='Pattern Making Skill Level', required=False),
        'sewing': forms.ChoiceField(choices=skill_levels, widget=forms.Select(attrs={'class': 'form-control'}), label='Sewing Skill Level', required=False),
        'fashion_marketing': forms.ChoiceField(choices=skill_levels, widget=forms.Select(attrs={'class': 'form-control'}), label='Fashion Marketing Skill Level', required=False),
    }
